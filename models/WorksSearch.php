...
class WorksSearch extends Works
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_sotrudnik', 'id_speciаlty', 'id_podpis', 'datez', 'name', 'status', 'typew', 'ozenka', 'mycheckwork', 'docmycheckwork', 'intercheckwork', 'docintercheckwork', 'publicwork', 'filework', 'statuswork'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'id_sotrudnik', $this->id_sotrudnik])
            ->andFilterWhere(['like', 'id_speciаlty', $this->id_speciаlty])
